<template>
  <div>
    ...
    <div id="Three-js-canvas" style="background-color:red; width: 100%; height: 100vh; position:relative;">
      <div style="position: absolute; color:white; width:100%; height:100%">
        <div class="container vertical-align" style="height:100%">
          <div class="row">
            <div class="col-lg-6 text-center" style="margin-top:20%;">
              <H1>Deep Green Ocean</H1>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-6 text-center">
              <H4>By Jimmy Zhang</H4>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    handleResize() {
      ...
      this.renderer.setSize(window.innerWidth*0.99, window.innerHeight)
    }
  },
  mounted() {
      this.init();
